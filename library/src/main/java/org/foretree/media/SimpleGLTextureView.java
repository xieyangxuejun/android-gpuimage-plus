 ...
 */
public class SimpleGLTextureView extends GLTextureView implements GLTextureView.Renderer, SurfaceTexture.OnFrameAvailableListener {
            ...
            queueEvent(new Runnable() {
                ...
                public void run() {
                    ...
                    if (mSurfaceTexture == null || mVideoTextureID == 0) {
                        ...
                        mSurfaceTexture.setOnFrameAvailableListener(SimpleGLTextureView.this);
                    }
                    _useUri();
                }
            });
    ...
    public SimpleGLTextureView(Context context, AttributeSet attrs) {
        super(context, attrs);
